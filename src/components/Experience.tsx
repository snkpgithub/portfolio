...
const jobs = [
  {
    ...
    bullets: [
      ...
      "Engineered scalable data and reporting applications using Python, FastAPI, and Superset with sub-second latency to support business decision-making.",
      ...
      "Established RESTful API design and service integration patterns; delivered documented, maintainable code and collaboration standards for cross-team development.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Deployed NLP systems with BERT, T5, and FAISS; applied novel feature engineering and data augmentation to achieve 28% improvement in semantic search accuracy.",
      ...
      "Applied knowledge distillation and weight pruning to production language models, reducing inference latency by 45% while preserving approximately 95% accuracy.",
    ],
    tag: "RESEARCH",
  },
  {
    ...
    bullets: [
      ...
      "Automated feature engineering and model evaluation pipelines on AWS SageMaker and Databricks with experiment tracking for rapid iteration.",
      ...
      "Wrote efficient SQL in PostgreSQL and Oracle for high-volume operational analytics; built Tableau and Streamlit dashboards for cross-functional stakeholders.",
    ],
    tag: "PRODUCTION",
  },
  {
    ...
    bullets: [
      ...
      "Established MLOps workflows with TensorFlow Serving for model monitoring, versioning, and refresh management in production environments.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Integrated CI/CD and monitoring workflows across 15+ cross-functional teams to standardize data pipelines for mission-critical reliability.",
    ],
    tag: "MISSION",
  },
];
